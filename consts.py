...
GAME_NAME_FONT_DIR = os.path.join(CWD, "helvetica_neue_bold.ttf")
...
SETTINGS_BOXES = [  pygame.Rect(220, 50, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),    # KB_UP
                    pygame.Rect(220, 80, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),    # KB_LEFT
                    pygame.Rect(220, 110, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # KB_DOWN
                    pygame.Rect(220, 140, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # KB_RIGHT
                    pygame.Rect(220, 170, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # KB_USE
                    pygame.Rect(220, 200, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # KB_INVENTORY
                    pygame.Rect(220, 230, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # KB_JOURNAL
                    pygame.Rect(220, 260, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # KB_ENTER
                    pygame.Rect(220, 290, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # KB_ESCAPE
                    pygame.Rect(220, 320, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # KB_LIFT
                    pygame.Rect(220, 350, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # KB_MAP
                    pygame.Rect(220, 420, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # volume
                    pygame.Rect(220, 480, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # brightness
                    pygame.Rect(220, 510, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT),   # save
                    pygame.Rect(220, 550, SETTINGS_SLIDER_WIDTH, SETTINGS_SLIDER_HEIGHT)]   # default


SETTINGS_BACKGROUND_COLORS = [MEDIUM_SLATE_BLUE, CYAN]
SETTINGS_BACKGROUND_BOX = pygame.Rect(140, -5, 600, 40)
SETTINGS_FONT_DIR = os.path.join(CWD, "helvetica_neue_bold.ttf")
SETTINGS_FONT_SIZE = 24
SETTINGS_FONT_COLOR = WHITE
SETTINGS_FONT_ANTIALIAS = True

KEY_FONT_DIR = os.path.join(CWD, "helvetica_neue_bold.ttf")
KEY_FONT_SIZE = 24
...
NPC_MAX_VALUE = 3
NPC_COUNT = 4
NPC_FONT_DIR = os.path.join(CWD, "helvetica_neue_bold.ttf")
NPC_FONT_SIZE = 24
...
PUZZLE_FONT_DIR = os.path.join(CWD, "helvetica_neue_bold.ttf")
...
INVENTORY_FONT_DIR = os.path.join(CWD, "helvetica_neue_bold.ttf")
...
ITEM_FONT_DIR = os.path.join(CWD, "helvetica_neue_bold.ttf")
...
JOURNAL_FONT_DIR = os.path.join(CWD, "helvetica_neue_bold.ttf")
...
DIALOGUE_FONT_DIR = os.path.join(CWD, "helvetica_neue_bold.ttf")
DIALOGUE_FONT_SIZE = 16
DIALOGUE_FONT_COLOR = BLACK
DIALOGUE_FONT_ANTIALIAS = True
DIALOGUE_FONT_SELECTED = CYAN
DIALOGUE_MAX_LINES = 5
DIALOGUE_BACKGROUND = WHITE
DIALOGUE_SHOW_BOX = pygame.Rect(0, 500, SCREEN_WIDTH, SCREEN_HEIGHT - 400)     # where to start displaying data
DIALOGUE_TEXT_BOX = pygame.Rect(25, 510, SCREEN_WIDTH, SCREEN_HEIGHT - 400)    # where to start displaying data
